...
public class HomePage {
	...
	@FindBy(how=How.XPATH, using="//a[contains(text(),'Manage Accounts')]") WebElement manageAccountsButton;
	@FindBy(how=How.XPATH, using="//a[contains(text(),'Register Account')]") WebElement registerAccountButton;
