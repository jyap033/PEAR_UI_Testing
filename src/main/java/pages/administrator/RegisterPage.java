...
public class RegisterPage {
    ...
    @FindBy(how = How.XPATH, using = "//input[@id='Input_FirstName']")
    WebElement firstNameTextBox;
    @FindBy(how = How.XPATH, using = "//input[@id='Input_LastName']")
    WebElement lastNameTextBox;
    @FindBy(how = How.XPATH, using = "//input[@id='Input_PreferedName']")
    WebElement preferedNameTextBox;
    @FindBy(how = How.XPATH, using = "//select[@id='Input_Gender']")
    WebElement genderDropdown;
    @FindBy(how = How.XPATH, using = "//input[@id='DOB']")
    WebElement dateOfBirthTextBox;
    @FindBy(how = How.XPATH, using = "//input[@id='Input_NRIC']")
    WebElement NRICTextBox;
    @FindBy(how = How.XPATH, using = "//input[@id='Input_Address']")
    WebElement addressTextBox;
    @FindBy(how = How.XPATH, using = "//input[@id='Input_Email']")
    WebElement emailTextBox;
    @FindBy(how = How.XPATH, using = "//input[@id='Input_Username']")
    WebElement usernameTextBox;
    @FindBy(how = How.XPATH, using = "//input[@id='Input_Password']")
    WebElement passwordTextBox;
    @FindBy(how = How.XPATH, using = "//input[@id='Input_ConfirmPassword']")
    WebElement confirmPasswordTextBox;
    @FindBy(how = How.XPATH, using = "//body/div[3]/div[1]/div[1]/div[2]/form[1]/div[4]/div[1]/div[1]/input[1]")
    WebElement registerButton;

    @FindBy(how = How.XPATH, using = "//select[@id='Input_RoleId']")
